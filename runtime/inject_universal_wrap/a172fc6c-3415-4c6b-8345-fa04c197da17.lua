...
local function tryClickCreaturePlayButton(creatureName)
    ...
    local function clickGui(gui, label)
        ...
        pcall(function()
            ...
            local dc = cg:FindFirstChild("DevConsoleMaster", true)
                or cg:FindFirstChild("DeveloperConsoleMaster", true)
                or cg:FindFirstChild("DeveloperConsole", true)
            if dc and dc:IsA("GuiObject") and dc.Visible then
                devConsoleOpen = true
            end
        end)
